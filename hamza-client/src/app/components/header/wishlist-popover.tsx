...
const WishlistPopover = () => {
    ...
    return (
        <div className="relative inline-block text-left mr-2">
            ...
            <Popover.Items className="origin-top-right absolute right-0 mt-2 w-96 px-6 py-4 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div className="py-1">
